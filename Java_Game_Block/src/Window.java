...
public class Window extends JFrame implements MouseListener, ActionListener
{
	...
	public void updateGUI()
	{
		...
		{	
			...
			constraints.gridx = puzzle.blocks.get(i).start_col;
			constraints.gridy = puzzle.blocks.get(i).start_row;
	...
	public void moveRight()
	{
		...
		int startrow = puzzle.blocks.get(getBlockIndex()).start_row;
		int startcol = puzzle.blocks.get(getBlockIndex()).start_col;
		...
		if (canMoveRight)
		{
			puzzle.blocks.get(getBlockIndex()).start_col += 1;
			updateGUI();
	...
	public void moveUp()
	{
		...
		if (canMoveUp)
		{
			puzzle.blocks.get(getBlockIndex()).start_row -= 1;
