...
public class PuzzleSolver
{
	...
	private class Snapshot
	{
		...
		public Snapshot(Snapshot old, char dir, int value, int updateBlock)
		{
			...
			if (dir == 'v')
				this.snapshotBlocks.get(updateBlock).start_row += value;
			if (dir == 'h')
				this.snapshotBlocks.get(updateBlock).start_col += value;
		}
	}
	...
	public void horizontalMove(Snapshot current, int block)
	{
		...
		int startrow = current.snapshotBlocks.get(block).start_row;
		int startcol = current.snapshotBlocks.get(block).start_col;
